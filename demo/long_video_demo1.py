...
def show_results_video(result_queue,
    ...
    if len(result_queue) != 0:
        ...
        for i, result in enumerate(results):
            ...
            p=open('pangolin.txt','a+')       #houjiada
            p.write(str(text))
...
def get_results_json(result_queue, text_info, thr, msg, ind, out_json):
    if len(result_queue) != 0:
        ...
        for i, result in enumerate(results):
            ...
            text_info[i+1] = selected_label
        out_json[ind] = text_info[1]
    elif len(text_info):
        out_json[ind] = text_info[1]
    else:
        out_json[ind] = msg
...
def main():
    ...
    for i in range(1,99):
        args.video_path = '/media/h/Elements/Z6交配2022/22-03-02.03.04/'+str(i)+'.mp4'
        args.out_file = 'z6/22-03-02.03.04/' + str(i) +'.json'
